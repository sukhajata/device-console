...
goog.exportSymbol('proto.config.GetConfigByIndexRequest', null, global);
 ...
 * @constructor
 */
proto.config.GetConfigByIndexRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.config.GetConfigByIndexRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.config.GetConfigByIndexRequest.displayName = 'proto.config.GetConfigByIndexRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {number}
 */
proto.config.SetDesiredRequest.prototype.getSlot = function() {
 ...
 * @return {!proto.config.SetDesiredRequest} returns this
 */
proto.config.SetDesiredRequest.prototype.setSlot = function(value) {
 ...
 * @return {number}
 */
proto.config.Identifier.prototype.getSlot = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.config.Identifier} returns this
 */
proto.config.Identifier.prototype.setSlot = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.config.GetConfigByIndexRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.config.GetConfigByIndexRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.config.GetConfigByIndexRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.config.GetConfigByIndexRequest}
 */
proto.config.GetConfigByIndexRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.config.GetConfigByIndexRequest;
  return proto.config.GetConfigByIndexRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.config.GetConfigByIndexRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.config.GetConfigByIndexRequest}
 */
proto.config.GetConfigByIndexRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.config.GetConfigByIndexRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.config.GetConfigByIndexRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.config.GetConfigByIndexRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.config.GetConfigByIndexRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIdentifier();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.config.GetConfigByIndexRequest.prototype.getIdentifier = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.config.GetConfigByIndexRequest.prototype.setIdentifier = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.config.GetConfigByIndexRequest.prototype.getIndex = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
